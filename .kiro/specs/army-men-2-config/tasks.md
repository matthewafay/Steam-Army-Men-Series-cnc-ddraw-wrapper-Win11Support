...
- [ ] 2. Implement resolution detection module
  ...
  - [x] 2.2 Write property test for resolution validation



    - **Property 1: Resolution values are valid positive integers**
    - **Validates: Requirements 1.1, 1.2**
  - [x] 2.3 Write unit tests for resolution detection
...
- [x] 3. Implement Steam locator module




  - [x] 3.1 Create Get-SteamInstallPath function
  ...
  - [x] 3.2 Create Get-SteamLibraryFolders function
  ...
  - [x] 3.3 Write property test for VDF parsing
  ...
  - [x] 3.4 Write unit tests for Steam locator
...
- [x] 4. Implement game finder module




  - [x] 4.1 Create Find-ArmyMen2Installation function
  ...
  - [x] 4.2 Write property test for game search
  ...
  - [x] 4.3 Write unit tests for game finder
...
- [x] 6. Implement compatibility configurator module





  - [x] 6.1 Create Set-CompatibilitySettings function
  ...
  - [x] 6.2 Write property test for compatibility flags
  ...
  - [x] 6.3 Write unit tests for compatibility settings
...
- [x] 7. Implement game configurator module





  - [x] 7.1 Create Set-GameResolution function
  ...
  - [x] 7.2 Write property test for configuration round-trip


    - **Property 5: Configuration round-trip preserves resolution**
    - **Validates: Requirements 4.2**
  - [x] 7.3 Write unit tests for game configuration
...
- [x] 8. Integrate all modules into main script





  - [x] 8.1 Wire up main execution flow
  ...
  - [x] 8.2 Write property test for status messages
